...
Many steps, many of which were unneeded to determine how $\left \langle  \mid \delta x  \mid \right \rangle$ should scale with $\left \langle x \right \rangle $ for each of our SDEs. Still, it's nice to have a more formal, if not exact, result.
